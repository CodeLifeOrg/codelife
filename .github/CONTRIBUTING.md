...
Here we have a set of instructions and guidelines to reduce misunderstandings and make the process of contributing to `codelife` as smooth as possible.
...
As a user of `codelife`, you're the perfect candidate to help us improve our documentation!
...
The [`question`](https://github.com/CodeLifeOrg/codelife/labels/type%3A%20question)
and
[`rfc`](https://github.com/CodeLifeOrg/codelife/labels/rfc)
...
- [`bug` issues](https://github.com/CodeLifeOrg/codelife/labels/type%3A%20bug)
  are known bugs we'd like to fix;
- [`enhancement` issues](https://github.com/CodeLifeOrg/codelife/labels/type%3A%20enhancement)
  are features we're open to include.

The
[`help wanted`](https://github.com/CodeLifeOrg/codelife/labels/help%20wanted)
and
[`good first issue`](https://github.com/CodeLifeOrg/codelife/labels/good%20first%20issue)
