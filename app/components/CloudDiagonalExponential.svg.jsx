    ...
    return (
      <svg className="cloud-diagonal-exponential" width="1280" height="616" viewBox="0 0 1280 616" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <g transform="translate(0 -807)" fill="none">
          <use fill="#fff" xlinkHref="#cloud-diagonal-exponential-a" />
          <use fill="#000" filter="url(#cloud-diagonal-exponential-b)" xlinkHref="#cloud-diagonal-exponential-a"/>
        </g>
        {/* fallback/hack */}
