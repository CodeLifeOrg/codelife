    ...
    return (
      <svg className="cloud-diagonal-gradual" width="1280" height="295" viewBox="0 0 1280 295" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        ...
        <g transform="translate(0 -1411)" fill="none">
          <use fill="#fff" xlinkHref="#cloud-diagonal-gradual-a"/>
          <use fill="#000" filter="url(#cloud-diagonal-gradual-b)" xlinkHref="#cloud-diagonal-gradual-a"/>
        </g>
        {/* fallback/hack */}
