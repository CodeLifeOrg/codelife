    ...
    return (
      <svg className="cloud-half" width="640" height="340" viewBox="0 0 640 320" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        <defs>
          ...
          <filter x="-3.4%" y="-10.3%" width="107%" height="114.1%" filterUnits="objectBoundingBox" id="cloud-half-c">
        ...
        <g fill="none">
          <use fill="#000" filter="url(#cloud-half-a)" xlinkHref="#cloud-half-b"/>
          <use fill="#fff" xlinkHref="#cloud-half-b"/>
          <use fill="#000" filter="url(#cloud-half-c)" xlinkHref="#cloud-half-b"/>
        </g>
        {/* fallback/hack */}
