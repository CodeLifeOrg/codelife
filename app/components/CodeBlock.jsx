...
class CodeBlock extends Component {
  ...
  getMeanings() {
    ...
    meanings.CONTAINS.h1 = t("<h1> is a header tag, where you can write really large text.");
    meanings.CONTAINS.h2 = t("<h2> is a header tag, where you can write kind of large text.");
    meanings.CONTAINS.h3 = t("<h3> is a header tag, where you can write large text.");
    meanings.CONTAINS.h4 = t("<h4> is a header tag, where you can write small text.");
    meanings.CONTAINS.h5 = t("<h5> is a header tag, where you can write kind of small text.");
    meanings.CONTAINS.h6 = t("<h6> is a header tag, where you can write really small text.");
    meanings.CONTAINS.style = t("<style> is where you customize your page with cool colors and fonts.");
    meanings.CONTAINS.p = t("<p> is a paragraph tag, write sentences in here.");
