module.exports = {
  link: [
    ...
    {rel: "stylesheet", href: "https://fonts.googleapis.com/css?family=Overpass:700|Roboto:400,400i,700"}
  ],
  meta: [
    {charset: "utf-8"},
    {"http-equiv": "X-UA-Compatible", "content": "IE=edge"},
    {name: "description", content: "CodeLife é uma plataforma online e gratuita voltada para alunos brasileiros do ensino médio que desejam aprender uma variedade de habilidades relevantes para trabalhar no setor de TI."},
